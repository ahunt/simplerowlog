...
\usepackage[colorlinks]{hyperref}
  ...
  \newcommand{\command}[1]{\begin{quote}\begin{small}\code{#1}\end{small}\end{quote}}
...
\input{appendix-getting_sources}
